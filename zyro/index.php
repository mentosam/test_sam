...
error_reporting(E_ALL); @ini_set('display_errors', true);
	$pages = array(
		'0'	=> array('id' => '1', 'alias' => '홈', 'file' => '1.php'),
		'1'	=> array('id' => '2', 'alias' => '소개', 'file' => '2.php'),
		'2'	=> array('id' => '3', 'alias' => '연락처', 'file' => '3.php')
	);
	$forms = array(
		'3'	=> array(
			'f4e1007e' => Array( 'email' => '', 'emailFrom' => '', 'subject' => 'Inquiry from the web page', 'sentMessage' => '양식이 보내졌습니다.', 'smtpEnable' => false, 'smtpHost' => null, 'smtpPort' => null, 'smtpEncryption' => null, 'smtpUsername' => null, 'smtpPassword' => null, 'recSiteKey' => null, 'recSecretKey' => null, 'fields' => array( array( 'fidx' => '0', 'name' => '제목', 'type' => 'input', 'options' => '' ), array( 'fidx' => '1', 'name' => '이메일', 'type' => 'input', 'options' => '' ), array( 'fidx' => '2', 'name' => '메세지', 'type' => 'textarea', 'options' => '' ) ) )
		)
	);
	$langs = null;
	$def_lang = null;
	...
	$base_url = '/';
	$user_domain = 'iyagi.esy.es';
	$show_comments = false;
	include dirname(__FILE__).'/functions.inc.php';
	$home_page = '1';
	list($page_id, $lang) = parse_uri();
	$user_key = "hmSL3LtDFCpTRr3i";
	$user_hash = "5fa4c793a6a19420";
	$comment_callback = "http://uk.zyro.com/ko-KR/comment_callback/";
	$preview = false;
	$mod_rewrite = true;
